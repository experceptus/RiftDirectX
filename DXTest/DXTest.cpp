                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_DXTEST, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_DXTEST));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_DXTEST);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HRESULT hr = D3D11CreateDevice(0,          // default adapter 
	   D3D_DRIVER_TYPE_HARDWARE, 0,          // no software device 
   ...
   if (FAILED(hr)) { MessageBox(0, L"D3D11CreateDevice Failed.", 0, 0); return false; }
